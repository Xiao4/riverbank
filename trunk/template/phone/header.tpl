...
<body>
<div style="width:100%;height:;background-color:#4F6EA6;color:#ffffff;margin-bottom:10px;TEXT-ALIGN:left;position:relative;">
	<h1 style="MARGIN:0 0 0 10px;"> <{$sitename}></h1>
	<div id="nav" style="background-color:#;TEXT-ALIGN:left;position:absolute;TOP:10px;LEFT:125px;">
		<ul>
